                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('movie.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <select name="category_id" id="" class="form-control">
                                @foreach ($category as $cate)
                                    <option value="{{ $cate->id }}">{{ $cate->tittle }}</option>
                                @endforeach
                        ...
                        <div class="form-group">
                            ...
                            <select name="genres_id" id="" class="form-control">
                                @foreach ($genre as $gen)
                                    <option value="{{ $gen->id }}">{{ $gen->tittle }}</option>
                                @endforeach
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="linkphim" class="form-control" placeholder="..." value="">
                        </div>
                        ...
                        <tbody>
                            @foreach ($list as $item )
                                <tr>
                                    ...
                                    <td>{{ $item->category->tittle}}</td>
                                    <td>{{ $item->genre->tittle }}</td>
                                    <td><img src="{{ asset('uploads/movie/'.$item->image) }}" alt="" style="max-width: 100%; height: auto;"></td>
                                    <td></td>
