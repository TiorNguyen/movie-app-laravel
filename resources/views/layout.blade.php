...
<html lang="vi">
   <head>
      ...
      <link rel="shortcut icon" href="{{ asset('uploads/logo.png') }}" type="image/x-icon" />
      ...
      <style>#header .site-title {background: url('uploads/logo.png') no-repeat top left;background-size: contain;text-indent: -9999px;}</style>
   </head>
                           ...
                           <div class="form-group form-timkiem ">
                              ...
                              <div class="input-group col-xs-12">
                                 <form action="{{ route('search') }}" method="GET">
                                    ...
                                    <button class="btn btn-primary" style="display: none">Search</button>
                                 </form>
                  ...
                  <div class="menu-menu_1-container">
                     <ul id="menu-menu_1" class="nav navbar-nav navbar-left">
                        ...
                        @foreach ($category as $item)
                           <li class="mega"><a title="{{ $item->tittle }}" href="{{ route('category',$item->id) }}">{{ $item->tittle }}</a></li>
                        @endforeach
                        ...
                        <li class="mega dropdown">
                           ...
                           <ul role="menu" class=" dropdown-menu">
                              @foreach ($genre as $item)
                                 <li><a title="{{ $item->tittle }}" href="{{ route('genre',$item->id) }}">{{ $item->tittle }}</a></li>
                              @endforeach
         ...
         <div class="container footer-columns">
            <div class="row container">
               <div class="widget about col-xs-12 col-sm-4 col-md-4">
                  ...
                  Liên hệ QC: Tu.nm27022003@gmail.com
               </div>
            </div>
         </div>
      </footer>
                  ...
                  $.getJSON('/json/movies.json',function (data) {
                     $.each(data,function (key,value) {
                        if(value.tittle.search(expression) != -1) {
                           $('#result').append('<li class="list-group-item" style = "cursor:pointer"> <img height="40" width="40" src="/uploads/movie/'+value.image+'" >'+value.tittle+' </li> ');
                        }
                     })
                  })
               }
