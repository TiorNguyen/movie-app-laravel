...
<div class="row container" id="wrapper">
    <div class="halim-panel-filter">
       <div class="panel-heading">
          <div class="row">
             <div class="col-xs-6">
                <div class="yoast_breadcrumb hidden-xs"><span><span><a href="danhmuc.php">Phim hay</a> » <span class="breadcrumb_last" aria-current="page">{{ $movie->tittle }}</span></span></span></span></div>
             </div>
          </div>
       </div>
             ...
             <div class="halim-movie-wrapper">
                ...
                <div class="movie_info col-xs-12">
                   ...
                   <div class="film-poster col-md-9">
                      <h1 class="movie-title title-1" style="display:block;line-height:35px;margin-bottom: -14px;color: #ffed4d;text-transform: uppercase;font-size: 18px;">{{ $movie->tittle }}</h1>
                      ...
                      <ul class="list-info-group">
                         ...
                         <li class="list-info-group-item"><span>Thể loại</span> : <a href="" rel="category tag">{{ $movie->genre->tittle }}</a></li>
