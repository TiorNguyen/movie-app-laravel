          ...
          <div class="row">
             <div class="col-xs-6">
               {{-- @foreach ($genre_home as $gen) --}}
                  <div class="yoast_breadcrumb hidden-xs"><span><span><a href="">{{ $genre_home->tittle }}</a> » <span class="breadcrumb_last" aria-current="page">2020</span></span></span></div>
               {{-- @endforeach --}}
    ...
    <main id="main-contents" class="col-xs-12 col-sm-12 col-md-8">
       <section>
          ...
          <div class="halim_box">
               ...
               @foreach ($genre_home->movie as $gen_mov)
                  <article class="col-md-3 col-sm-3 col-xs-6 thumb grid-item post-27021">
                     <div class="halim-item">
                        <a class="halim-thumb" href="{{ route('movie',$gen_mov->id) }}" title="{{ $gen_mov->tittle }}">
                           <figure><img class="lazy img-responsive" src="{{ asset('uploads/movie/'.$gen_mov->image) }}" alt="{{ $gen_mov->tittle }}" title="{{ $gen_mov->tittle }}"></figure>
                           <span class="status">5/5</span><span class="episode"><i class="fa fa-play" aria-hidden="true"></i>Vietsub</span> 
                           <div class="icon_overlay"></div>
                           <div class="halim-post-title-box">
                              <div class="halim-post-title ">
                                 <p class="entry-title">{{ $gen_mov->tittle }}</p>
